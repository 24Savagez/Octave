...
centers_g = imfindcircles(color_img_green,[40 120]);
[centers_g, radii_g] = imfindcircles (color_img_green, [20 60]);
figure(5)
hold on
imshow(img)
...
centers_r = imfindcircles(color_img_red,[40 120]);
[centers_r, radii_r] = imfindcircles (color_img_red, [20 60]);
figure(6)
hold on
imshow(img)
viscircles (centers_r, radii_r)
