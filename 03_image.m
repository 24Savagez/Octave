...
for i = 1:varsize(1)
  for j = 1:varsize(2)
    ...
    C(i,j) = (2^16)-(img(i,j,1))-((2^16)-(max(img(i,j,:))))/(2^16)-(max(img(i,j,:)));
    M(i,j) = (2^16)-(img(i,j,2))-((2^16)-(max(img(i,j,:))))/(2^16)-(max(img(i,j,:)));
    Y(i,j) = (2^16)-(img(i,j,3))-((2^16)-(max(img(i,j,:))))/(2^16)-(max(img(i,j,:)));
  endfor
endfor
K = uint16(K);
C = uint16(C);
